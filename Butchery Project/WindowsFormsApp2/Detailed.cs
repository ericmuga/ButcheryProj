...

    {
        ...
        private void loaddata()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
               ...
               DateTime To = Convert.ToDateTime(this.SlaughterDateTo.Text);
                ...
                String q = "SELECT  Itemno,outputpname AS 'OUT PUT',outputptype AS TYPE,sum(CAST(nopieces AS decimal(18,2))) AS 'PIECES',sum(CAST(NetWeight AS decimal(18,2))) as Weight FROM ButcheryData WHERE parentItemNo='"+inputtype + "' and outputptype='MAIN PRODUCT' and  ButchTime >='" + startDate.ToString("dd/MMM/yyyy") + "' and  ButchTime <= '" + To.ToString("dd/MMM/yyyy") + "'group by outputpname,Itemno,outputptype ";
        ...
        private void loaddataby()
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                String q = "SELECT  Itemno,outputpname AS 'OUT PUT',outputptype AS TYPE,sum(CAST(nopieces AS decimal(18,2))) AS 'PIECES',sum(CAST(NetWeight AS decimal(18,2))) as Weight FROM ButcheryData WHERE parentItemNo='" + inputtype + "' and outputptype='BY PRODUCT' and  ButchTime >='" + startDate.ToString("dd/MMM/yyyy") + "' and  ButchTime <= '" + To.ToString("dd/MMM/yyyy") + "'group by outputpname,Itemno,outputptype ";
        ...
        private void Detailed_Load(object sender, EventArgs e)
        {
           ...
           // PopulateDataGridView();
            ...
            Txtinputtype.Items.Add("MIDDLES");
            Txtinputtype.Items.Add("SHOULDERS");
